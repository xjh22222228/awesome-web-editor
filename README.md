...
- Pure JavaScript
  - [quill](https://github.com/quilljs/quill) ★ 46167 - Quill is a modern WYSIWYG editor built for compatibility and extensibility.
  - [tiptap](https://github.com/heyscrumpy/tiptap) ★ 32642 - The headless rich text editor framework for web artisans.
  - [Editor.js](https://github.com/codex-team/editor.js) ★ 30843 - A block-styled editor with clean JSON output.
  - [lexical](https://github.com/facebook/lexical) ★ 22162 - Lexical is an extensible text editor framework that provides excellent reliability, accessibility and performance.
...
- react
  ...
  - [draft-js](https://github.com/facebook/draft-js) ★ 22757 - A React framework for building text editors.
  - [plate](https://github.com/udecode/plate) ★ 15103 - A rich-text editor powered by AI.
...
- Pure JavaScript
  ...
  - [milkdown](https://github.com/Saul-Mirone/milkdown) ★ 10545 - Plugin driven WYSIWYG markdown editor framework.
...
- React
  - [mdx](https://github.com/mdx-js/mdx) ★ 18841 - MDX is an authorable format that lets you seamlessly use JSX in your markdown documents. You can import components, like interactive charts or notifications, and export metadata. This makes writing long-form content with components a blast.
...
- JavaScript
  - [marked](https://github.com/markedjs/marked) ★ 35643 - A markdown parser and compiler. Built for speed.
  - [markdown-it](https://github.com/markdown-it/markdown-it) ★ 20320 - Markdown parser, done right. 100% CommonMark support, extensions, syntax plugins & high speed.
  ...
  - [turndown](https://github.com/domchristie/turndown) ★ 10281 - An HTML to Markdown converter written in JavaScript.
  - [remark](https://github.com/remarkjs/remark) ★ 8479 - remark is a Markdown processor powered by plugins part of the unified collective.
...
- Golang
  ...
  - [goldmark](https://github.com/yuin/goldmark) ★ 4316 - A markdown parser written in Go. Easy to extend, standard(CommonMark) compliant, well structured.
  - [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ★ 3090 - Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
- Python
...
- [github-markdown-css](https://github.com/sindresorhus/github-markdown-css) ★ 8582 - The minimal amount of CSS to replicate the GitHub Markdown style.
...
- markdown
  ...
  - [md](https://github.com/doocs/md) ★ 10627 - WeChat Markdown Editor.
...
- SVG
  - [svgedit](https://github.com/SVG-Edit/svgedit) ★ 7247 - Powerful SVG-Editor for your browser.
...
- [monaco-editor](https://github.com/Microsoft/monaco-editor) ★ 44045 - A browser based code editor.
...
- [jsoncrack.com](https://github.com/AykutSarac/jsoncrack.com) ★ 41308 - Innovative and open-source visualization application that transforms various data formats, such as JSON, YAML, XML, CSV and more, into interactive graphs.
...
- Pure JavaScript
  - [grapesjs](https://github.com/GrapesJS/grapesjs) ★ 24895 - The embeddable drag-and-drop builder.
  - [VvvebJs](https://github.com/givanz/VvvebJs) ★ 8190 - Drag and drop website builder javascript library.
- React
  - [Excalidraw](https://github.com/excalidraw/excalidraw) ★ 107264 - Virtual whiteboard for sketching hand-drawn like diagrams.
