...
- Pure JavaScript
  - [quill](https://github.com/quilljs/quill) ★ 46048 - Quill is a modern WYSIWYG editor built for compatibility and extensibility.
  - [tiptap](https://github.com/heyscrumpy/tiptap) ★ 32375 - The headless rich text editor framework for web artisans.
  - [Editor.js](https://github.com/codex-team/editor.js) ★ 30773 - A block-styled editor with clean JSON output.
  - [lexical](https://github.com/facebook/lexical) ★ 21888 - Lexical is an extensible text editor framework that provides excellent reliability, accessibility and performance.
  ...
  - [tinymce](https://github.com/tinymce/tinymce) ★ 15825 - The world's most popular JavaScript library for rich text editing. Available for React, Vue and Angular.
  - [pell](https://github.com/jaredreich/pell) ★ 12049 - the simplest and smallest WYSIWYG text editor for web, with no dependencies.
  - [ckeditor5](https://github.com/ckeditor/ckeditor5) ★ 10228 - Development environment for CKEditor 5 – the best browser-based rich text editor.
  - [prosemirror](https://github.com/ProseMirror/prosemirror) ★ 8314 - The ProseMirror WYSIWYM editor.
  ...
  - [canvas-editor](https://github.com/Hufe921/canvas-editor) ★ 4479 - rich text editor by canvas/svg.
  ...
  - [Textbus](https://github.com/textbus/textbus) ★ 1339 - A component-based and high-performance rich text develop framework that Support online collaborative editing.
...
- react
  ...
  - [draft-js](https://github.com/facebook/draft-js) ★ 22709 - A React framework for building text editors.
  - [plate](https://github.com/udecode/plate) ★ 14979 - A rich-text editor powered by AI.
...
- Pure JavaScript
  ...
  - [milkdown](https://github.com/Saul-Mirone/milkdown) ★ 10483 - Plugin driven WYSIWYG markdown editor framework.
...
- React
  - [mdx](https://github.com/mdx-js/mdx) ★ 18792 - MDX is an authorable format that lets you seamlessly use JSX in your markdown documents. You can import components, like interactive charts or notifications, and export metadata. This makes writing long-form content with components a blast.
  - [react-markdown](https://github.com/remarkjs/react-markdown) ★ 14905 - Render Markdown as React components.
  - [milkdown](https://github.com/Saul-Mirone/milkdown) ★ 10483 - Plugin driven WYSIWYG markdown editor framework.
...
- JavaScript
  - [marked](https://github.com/markedjs/marked) ★ 35500 - A markdown parser and compiler. Built for speed.
  - [markdown-it](https://github.com/markdown-it/markdown-it) ★ 20239 - Markdown parser, done right. 100% CommonMark support, extensions, syntax plugins & high speed.
  ...
  - [turndown](https://github.com/domchristie/turndown) ★ 10217 - An HTML to Markdown converter written in JavaScript.
...
- Golang
  ...
  - [goldmark](https://github.com/yuin/goldmark) ★ 4299 - A markdown parser written in Go. Easy to extend, standard(CommonMark) compliant, well structured.
...
- Java
  - [commonmark-java](https://github.com/commonmark/commonmark-java) ★ 2533 - Java library for parsing and rendering CommonMark (Markdown).
- C#
...
- [github-markdown-css](https://github.com/sindresorhus/github-markdown-css) ★ 8535 - The minimal amount of CSS to replicate the GitHub Markdown style.
...
- markdown
  ...
  - [md](https://github.com/doocs/md) ★ 10510 - WeChat Markdown Editor.
...
- SVG
  - [svgedit](https://github.com/SVG-Edit/svgedit) ★ 7222 - Powerful SVG-Editor for your browser.
  - [Method-Draw](https://github.com/methodofaction/Method-Draw) ★ 2934 - Method Draw, the SVG Editor for Method of Action.
- [CodeMirror](https://github.com/codemirror/CodeMirror) ★ 27127 - In-browser code editor.
- [monaco-editor](https://github.com/Microsoft/monaco-editor) ★ 43827 - A browser based code editor.
...
- [jsoncrack.com](https://github.com/AykutSarac/jsoncrack.com) ★ 41179 - Innovative and open-source visualization application that transforms various data formats, such as JSON, YAML, XML, CSV and more, into interactive graphs.
...
- Pure JavaScript
  - [grapesjs](https://github.com/GrapesJS/grapesjs) ★ 24794 - The embeddable drag-and-drop builder.
  - [VvvebJs](https://github.com/givanz/VvvebJs) ★ 8161 - Drag and drop website builder javascript library.
- React
  - [Excalidraw](https://github.com/excalidraw/excalidraw) ★ 106495 - Virtual whiteboard for sketching hand-drawn like diagrams.
