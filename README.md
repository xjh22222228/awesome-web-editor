...
- jQuery
  - [summernote](https://github.com/summernote/summernote) ★ 9940 - Super simple WYSIWYG editor, Summernote is built on jQuery.
...
## Markdown editor
- Pure JavaScript
  - [tui.editor](https://github.com/nhnent/tui.editor) ★ 12135 - Markdown WYSIWYG Editor. GFM Standard + Chart & UML Extensible.
  ...
  - [dillinger](https://github.com/joemccann/dillinger) ★ 6925 - The last Markdown editor, ever.
  - [pen](https://github.com/sofish/pen) ★ 4699 - enjoy live editing (+markdown).
...
- jQuery
  - [editor.md](https://github.com/pandao/editor.md) ★ 10529 - The open source embeddable online markdown editor (component).
- vue.js
...
- JavaScript
  ...
  - [showdown](https://github.com/showdownjs/showdown) ★ 11322 - A bidirectional MD to HTML to MD converter written in Javascript.
  - [markdown-it](https://github.com/markdown-it/markdown-it) ★ 10760 - Markdown parser, done right. 100% CommonMark support, extensions, syntax plugins & high speed.
...
- [Markdown Syntax](https://github.com/younghz/Markdown) ★ 2420 - markdown tutorials.
