...
- Pure JavaScript
  ...
  - [milkdown](https://github.com/Saul-Mirone/milkdown) ★ 10736 - Plugin driven WYSIWYG markdown editor framework.
...
- React
  - [mdx](https://github.com/mdx-js/mdx) ★ 18998 - MDX is an authorable format that lets you seamlessly use JSX in your markdown documents. You can import components, like interactive charts or notifications, and export metadata. This makes writing long-form content with components a blast.
  - [react-markdown](https://github.com/remarkjs/react-markdown) ★ 15175 - Render Markdown as React components.
  - [milkdown](https://github.com/Saul-Mirone/milkdown) ★ 10736 - Plugin driven WYSIWYG markdown editor framework.
...
- Golang
  ...
  - [goldmark](https://github.com/yuin/goldmark) ★ 4412 - A markdown parser written in Go. Easy to extend, standard(CommonMark) compliant, well structured.
  - [html-to-markdown](https://github.com/JohannesKaufmann/html-to-markdown) ★ 3187 - Convert HTML to Markdown. Even works with entire websites and can be extended through rules.
- Python
...
- Java
  - [commonmark-java](https://github.com/commonmark/commonmark-java) ★ 2578 - Java library for parsing and rendering CommonMark (Markdown).
- C#
...
- [monaco-editor](https://github.com/Microsoft/monaco-editor) ★ 44616 - A browser based code editor.
...
- React
  - [Excalidraw](https://github.com/excalidraw/excalidraw) ★ 110371 - Virtual whiteboard for sketching hand-drawn like diagrams.
  - [react-email-editor](https://github.com/unlayer/react-email-editor) ★ 5024 - Drag-n-Drop Email Editor Component for React.js.
