...
- jQuery
  - [summernote](https://github.com/summernote/summernote) ★ 9940 - 超级简单的所见即所得编辑器，Summernote基于jQuery构建。
...
## Markdown 编辑器
- 纯JavaScript
  - [tui.editor](https://github.com/nhnent/tui.editor) ★ 12135 - Markdown所见即所得编辑器。 GFM标准+图表和UML可扩展。
  ...
  - [dillinger](https://github.com/joemccann/dillinger) ★ 6925 - 最后一个Markdown编辑器。
...
- jQuery
  - [editor.md](https://github.com/pandao/editor.md) ★ 10529 - 开源可嵌入在线Markdown编辑器（组件）。
- vue.js
...
- JavaScript
  ...
  - [showdown](https://github.com/showdownjs/showdown) ★ 11322 - 用JavaScript编写的双向MD到HTML到MD转换器。
  - [markdown-it](https://github.com/markdown-it/markdown-it) ★ 10760 - Markdown解析器， 100％CommonMark支持，扩展，语法插件和高速。
...
- [markdown基本语法](https://github.com/younghz/Markdown) ★ 2420 - markdown 语法教程.
